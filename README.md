...
- [go-stress-testing](https://go-stress-testing/releases) 压测工具下载地址
...
- 项目地址 [https://go-stress-testing](https://go-stress-testing)

### 4.2 用法

- [go-stress-testing](https://go-stress-testing/releases) 下载地址
...
- 压测结果
- [压测结果 示例](https://go-stress-testing/issues/32)
...
### 4.5 grpc压测
- 介绍如何压测 grpc 接口
> [添加对 grpc 接口压测 commit](https://go-stress-testing/commit/2b4b14aaf026d08276531cf76f42de90efd3bc61)
- 1. 启动Server
```shell script
# 进入 grpc server 目录
cd tests/grpc
...
> 参考 [添加对 grpc 接口压测 commit](https://go-stress-testing/commit/2b4b14aaf026d08276531cf76f42de90efd3bc61)
...
之前写了一篇文章，[基于websocket单台机器支持百万连接分布式聊天(IM)系统](https://gowebsocket)(不了解这个项目可以查看上一篇或搜索一下文章)，这里我们要实现单台机器支持100W连接的压测
...
[基于websocket单台机器支持百万连接分布式聊天(IM)系统](https://gowebsocket)

[https://go-stress-testing](https://go-stress-testing)

github 搜:link1st 查看项目 go-stress-testing

### 意见反馈

- 在项目中遇到问题可以直接在这里找找答案或者提问 [issues](https://go-stress-testing/issues)
